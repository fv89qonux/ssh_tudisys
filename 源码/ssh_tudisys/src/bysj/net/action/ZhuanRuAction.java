...
public class ZhuanRuAction extends ActionSupport {
	private ZhuanRu util;
	private PageModel<ZhuanRu> pageModel;
	...
	public String initUtil() throws Exception{
		listDangAn = objectManager.getUtil("from DangAn where s_10 ='待转入'");
	...
	public String saveOrUpdateObject() throws Exception{
		if("".equals(util.getS_0()) || null == util.getS_0()){
			util.setS_0("ZR"+ new SimpleDateFormat("hhmmsss").format(new Date()));
		}
	...
	public String selectUtil() throws Exception{
		...
		listUser = objectManager.getUtil("from User");
		util = (ZhuanRu) objectManager.getObject(new ZhuanRu(), util.getId());
		return "saveOrUpdate";
	}
	...
	public ZhuanRu getUtil() {
		return util;
	}

	public void setUtil(ZhuanRu util) {
		this.util = util;
	}
	...
	public PageModel<ZhuanRu> getPageModel() {
		return pageModel;
	}

	public void setPageModel(PageModel<ZhuanRu> pageModel) {
