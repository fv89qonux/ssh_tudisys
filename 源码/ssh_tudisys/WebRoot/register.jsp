...
<body
	...
	<div class="logintop">
		<span>欢迎光临<spring:message code="system_name" />
		</span>
	</div>
			...
			<div class="loginbox">
				...
				<ul>
					...
					<li><input name="code" type="text" class="logincd"
						...
						id="safecode" src="imageServlet" onClick="flushCode()" /></li>
					<li><input name="" type="submit" class="loginbtn" value="注册" />
						<label> </label> <label> <a href="login.jsp">已有帐号？直接登录</a>
					</label> <font color=red><s:property value="errMsg" /> </font></li>
				</ul>
			</div>
		</div>
	</form>
