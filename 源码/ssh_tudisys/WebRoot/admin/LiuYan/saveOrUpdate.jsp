...
<body>
	...
	<div class="formbody">
		<form
			action="${pageContext.request.contextPath}/LiuYan-saveOrUpdateObject.action"
			...
			<table
				...
				<thead>
					<tr>
						<td colspan="4"><b>留言管理 </b></td>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td>留言人</td>
						<td colspan="3"><select class="select2" name="util.user.id">
					...
					<tr>
						...
						<td width="500" colspan="3" height=""><textarea id="content7"
								name="util.s_4" style="width: 95%" rows="4" cols="5">${util.s_4 }</textarea>
						</td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
						<td>&nbsp;</td>
						<td colspan="3"><input class="btn btn-inverse" id="find"
							type="submit" value="保存" />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
							class="btn btn-inverse" type="reset" value="取消" /><font
							color=red><s:property value="errMsg" /> </font></td>
					</tr>
				</tfoot>
			</table>
		</form>
