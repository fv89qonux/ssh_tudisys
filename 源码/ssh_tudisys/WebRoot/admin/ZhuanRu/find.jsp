...
<script type="text/javascript">
	function topPage() {
		...
		window.location = contextPath
				+ '/ZhuanRu-getAllUtil.action?pageModel.currentPageNo='
...
<body>
	...
	<div class="rightinfo">
		<div class="tools">
			...
			<form
				action="${pageContext.request.contextPath}/ZhuanRu-getAllUtil.action">
		...
		<form
			action="${pageContext.request.contextPath}/ZhuanRu-deleteManyUtil.action"
							...
							<tr>
								...
								<td><c:if test="${type == 'admin'}">
										<a target="Conframe" class="tablelink"
											href="${pageContext.request.contextPath}/ZhuanRu-selectUtil.action?util.id=${tmp.id }">修改
										</a>
										<a target="Conframe" class="tablelink"
											href="${pageContext.request.contextPath}/ZhuanRu-deleteUtil.action?util.id=${tmp.id }">删除
										</a>
									</c:if> <c:if test="${type != 'admin'}">
										<a target="Conframe" class="tablelink"
											href="${pageContext.request.contextPath}/ZhuanRu-selectUtil.action?util.id=${tmp.id }">查看
										</a>
									</c:if></td>
							</tr>
						</c:forEach>
